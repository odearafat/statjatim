...
public class NoInternetConnectionFragment extends Fragment {
    ...
    public static NoInternetConnectionFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button bttnMuatUlang=view.findViewById(R.id.reloadConnection);

        bttnMuatUlang.setOnClickListener(new View.OnClickListener() {
            @Override
