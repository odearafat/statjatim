...
import com.bps_jatim_3500.statistik_jatim.Adapter.InfografisAdapter;
...
import com.bps_jatim_3500.statistik_jatim.interfacePackage.InfografisHolderApi;
...
public class InfografisFragment extends Fragment {
    ...
    InfografisAdapter infografisAdapter;
    RecyclerView recyclerView;
    ProgressBar progressBar;
    List<InfografisItem> infografisItems;
    ...
    public InfografisFragment(MainActivity mainActivity){
    ...
    protected InfografisFragment.LayoutManagerType mCurrentLayoutManagerType= InfografisFragment.LayoutManagerType.LINEAR_LAYOUT_MANAGER;

    //RecycleView List of Data
    InfografisHolderApi jsonPlaceHolderApi;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v=inflater.inflate(R.layout.fragment_infografis,container,false);
        ...
        mCurrentLayoutManagerType = InfografisFragment.LayoutManagerType.LINEAR_LAYOUT_MANAGER;

        if (savedInstanceState != null) {
            // Restore saved layout manager type.
            mCurrentLayoutManagerType = (InfografisFragment.LayoutManagerType) savedInstanceState
    ...
    public void getListData(){
        ...
        jsonPlaceHolderApi=retrofit.create(InfografisHolderApi.class);
        Call<Infografis> call=jsonPlaceHolderApi.getList(
                "infographic", mainActivity.getIdWilayah(), "2ad01e6a21b015ea1ff8805ced02600c", ""+pageNumber,
        ...
        //Callback
        call.enqueue(new Callback<Infografis>() {
            @RequiresApi(api = Build.VERSION_CODES.N)

            @Override
            public void onResponse(Call<Infografis> call, Response<Infografis> response) {

                if(!response.isSuccessful()){
                    getResult="Code : "+response.code();
                    return;
                }
                Infografis infografis=response.body();

                //Cast to Page
                Page page=new Gson().fromJson(infografis.getData().get(0).toString(), Page.class);

                //Cast to List of Publikasi Item
                infografisItems = stringToArray(new Gson().toJson(infografis.getData().get(1)), InfografisItem[].class);

                infografisAdapter=new InfografisAdapter(getContext(),infografisItems, dialogDetailPublikasi, mainActivity);
                recyclerView.setAdapter(infografisAdapter);

                progressBar.setVisibility(View.GONE);
            }

            @Override
            public void onFailure(Call<Infografis> call, Throwable t) {
                progressBar.setVisibility(View.GONE);
    ...
    public void performPagination(){
        ...
        call.enqueue(new Callback<Infografis>() {
            ...
            public void onResponse(Call<Infografis> call, Response<Infografis> response) {
               ...
               //Cast to List of Publikasi Item
                List<InfografisItem>infografisItem2 = stringToArray(new Gson().toJson(infografis.getData().get(1)), InfografisItem[].class);

                //publikasiItems.addAll(publikasiItem2);
                infografisAdapter.addInfografisItemList(infografisItem2);
    ...
    private void setRecyclerViewLayoutManager(InfografisFragment.LayoutManagerType layoutManagerType) {
        ...
        switch (layoutManagerType) {
            case GRID_LAYOUT_MANAGER:
                ...
                mCurrentLayoutManagerType = InfografisFragment.LayoutManagerType.GRID_LAYOUT_MANAGER;
                break;
            case LINEAR_LAYOUT_MANAGER:
                mLayoutManager = new LinearLayoutManager(this.getContext(), LinearLayoutManager.HORIZONTAL,true);
                mCurrentLayoutManagerType = InfografisFragment.LayoutManagerType.LINEAR_LAYOUT_MANAGER;
                break;
            default:
                mLayoutManager = new LinearLayoutManager(this.getContext());
